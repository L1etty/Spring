...
<body>
	...
	<h3>소수점 표현</h3>
	<c:set var="pi" value="3.1415987668423"/>
	<h4>${pi}</h4>
	<h4><fmt:formatNumber value="${pi}" pattern="#.##"/></h4>
	<h4><fmt:formatNumber value="${pi}" pattern="0.00000000000000000"/></h4>
	<h4><fmt:formatNumber value="${pi}" pattern="#.###################"/></h4>
	...
	<h4><fmt:parseDate value="${dateString}" var="date" pattern="yyyy/MM/dd HH:mm:ss" /></h4>
	<h4>${date}</h4>
